...
let tgtjson = '{"黒毛和牛":{"101":[{"1010":"せいろ蒸し(10000円)"},{"1011":"せいろ蒸し(18000円)"}],"102":[{"1020":"焼き肉(10000円)"},{"1021":"焼き肉(18000円)"}]},"神戸牛":{"201":[{"2010":"神戸牛せいろ蒸し(8000円)"},{"2011":"神戸牛せいろ蒸し(12000円)"}],"202":[{"2020":"神戸牛焼き肉(5000円)"},{"2021":"神戸牛焼き肉(8000円)"}]}}';
let complexJson = JSON.parse(tgtjson);
for (var item in complexJson) {
    console.log(item + ': ' + complexJson['黒毛和牛']);
}
